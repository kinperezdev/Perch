...
enum MessageLibrary {
    ...
    static func variants(kind: ReminderKind, personality: Personality) -> [String] {
        ...
        case (.water, .mother): return [
            "Sweetheart, have you had any water lately? Please drink a glass now.",
            "{name}, did you remember to drink water? I worry when you forget."]
        case (.water, .homie): return [
            "Yo {name}, have you had any water? Grab a glass real quick.",
            "Bro, have you had water? It helps you think, trust me."]
        ...
        case (.water, .coach): return [
            "Have you had water yet, {name}? One glass, then back to it.",
            "Athletes drink water, builders should too. Did you take a water break?"]
        ...
        case (.stretch, .homie): return [
            "Bro, you've been sitting for {duration}. Did you stretch yet?",
            "{name}, how about a quick stretch? A stiff neck won't help your work."]
        ...
        case (.stretch, .coach): return [
            "{duration} of focus! Time to stand up and stretch. Reach tall.",
            "Time out! Did you stretch your shoulders? Rest is part of doing well."]
        ...
        case (.eyes, .homie): return [
            ...
            "Are you giving your eyes a rest, bro? Twenty seconds, something far away."]
        ...
        case (.eyes, .coach): return [
            "Did you rest your eyes yet? Twenty seconds, look far away.",
        ...
        case (.posture, .coach): return [
            "Posture check, {name}! Chest up, shoulders back?",
            "Did you fix your posture? Sitting well matters too."]
        ...
        case (.walk, .coach): return [
            "Quick walk time! Did you get up and move, {name}?",
            "{duration} sitting down! Want to take a quick walk before we continue?"]
        ...
        case (.meal, .homie): return [
            ...
            "You skipped {meal} yesterday. Are you going to go eat now?"]
        ...
        case (.meal, .coach): return [
            "Time to eat, {name}! Have you had your {meal}?",
            "Eating well matters too. Did you get your {meal}, champ?"]
        ...
        case (.shower, .coach): return [
            "Shower time, {name}! Did you take yours?",
            "Time for a quick reset, champ. Have you showered?"]
        ...
        case (.overwork, .homie): return [
            "Bro. {duration} straight. Big effort, but even you need a break. Breathe.",
            "{name}, you've been focused {duration}. Respect. Now step away for a few, seriously."]
        ...
        case (.overwork, .mentor): return [
            "{duration} of continuous work, {name}. The craft rewards a steady pace, not exhaustion.",
            "You've gone {duration} deep. Come up for air. Long work is done in stages."]
        case (.overwork, .coach): return [
            "{duration} straight, {name}! That's a lot of effort. Time for a real break, right now.",
            "That's a lot of overtime! {duration} in. Rest on purpose. Take the break."]
        ...
        case (.windDown, .homie): return [
            "Yo {name}, your shift's over. Save your work and shut it down. Tomorrow you'll pick it back up.",
            "Past quitting time, bro. Save your progress. Life needs attention too."]
        ...
        case (.windDown, .coach): return [
            "Day's done, {name}! Great work today. Time to wrap up and rest.",
            "Work is done for today. Time to rest. That's an order, champ."]
        case (.windDown, .playful): return [
            "The sun clocked out and honestly, so should you, {name}.",
            "Closing time in here. Save your work, stretch, and enjoy the evening."]
        ...
        case (.sleep, .homie): return [
            "Bro, it's really late. Sleep helps you do better tomorrow. Go get it.",
            "{name}, it's time to stop. Rest matters, even when you're busy."]
        ...
        case (.sleep, .mentor): return [
            ...
            "The night belongs to your dreams, not your deadlines."]
        case (.sleep, .coach): return [
            "Rest is when you improve, {name}. Lights out soon, that's the move.",
            "Work time is over. Sleep helps you tomorrow. Go rest."]
        case (.sleep, .playful): return [
            "Even your computer wants to sleep. Race you to bed, {name}.",
            "It's past midnight. Everyone needs rest to recharge. Go get yours."]
        ...
        case (.meetingPrep, .homie): return [
            "Heads up {name}, {event} in {mins} minutes. Wrap this thought and get ready.",
        ...
        case (.meetingPrep, .coach): return [
            "{event} starts in {mins} minutes. Head up, notes ready, {name}!",
            "{event} in {mins} minutes. Get ready now, show up sharp."]
        ...
        case (.meetingRecovery, .coach): return [
            "Meeting's done, {name}! Quick reset: water, stand, breathe. Then keep going.",
            "Meeting's done. Take two minutes to reset."]
        case (.meetingRecovery, .playful): return [
            "You escaped the meeting! Celebrate with water and thirty seconds of staring at nothing.",
            "Meeting over. Your social energy is low. Please recharge before continuing."]
        ...
        case (.routine, .mentor): return [
            ...
            "It's time for {routine}, {name}. Small habits build the person."]
        case (.routine, .coach): return [
            "Reminder, {name}: {routine}. Staying consistent pays off.",
            "Time for {routine}! Small habits add up over time."]
        ...
        case (.status, .homie): return [
            ...
            "{duration} focused, bro. You good, or you need a break?"]
        ...
        case (.status, .mentor): return [
            ...
            "Things flow well at {duration}. Are you still feeling good about the pace?"]
        case (.status, .coach): return [
            "{duration} in and looking strong, {name}! How are you feeling?",
            "Good pace, {duration} in! Still got energy, or need a break?"]
        ...
        case (.sessionStart, .coach): return [
            "Let's start, {name}! Ready to focus?",
            "Let's go! Time to get to work."]
        case (.sessionStart, .playful): return [
            "A focus session appears! Ready, {name}?",
            "I'm ready to watch over you. Starting focus now?"]
        ...
        case (.welcome, .homie): return [
            "Yo {name}! I'm here. You build, I'll keep an eye on things. Let's go."]
        ...
        case (.welcome, .coach): return [
            "{name}, I'm here! You focus on the work, I'll take care of your breaks."]
    ...
    static func confirmations(response: CheckInResponse, personality: Personality) -> [String] {
        ...
        case .done, .timerCompleted:
            ...
            case .homie: return ["That's what I'm talking about.", "Easy. Back to work, bro."]
            ...
            case .coach: return ["Nice work! Logged.", "That's the discipline. Go."]
        ...
        case .snoozed:
            ...
            case .homie: return ["Bet. I'll circle back in a few.", "Alright, snoozed. Don't ghost me though."]
            ...
            case .coach: return ["Got it. I'll check back soon, then we go.", "Snooze logged. We go again shortly."]
        ...
        case .ignored, .timedOut:
            ...
            case .homie: return ["All good. I'll catch you later.", "Got it. I'm around if you need me."]
            ...
            case .coach: return ["Got it. Back to work.", "Got it. I'll stay close by."]
    ...
    static func thanksReplies(personality: Personality) -> [String] {
        ...
        case .homie: ["Got you, bro. Now actually do it.", "Anytime. I've got your back."]
        ...
        case .coach: ["That's my job! Now go take it, {name}.", "Anytime! Rest matters too."]
    ...
    static func sample(personality: Personality) -> String {
        ...
        case .homie: "Bro, you've been focused for 3 hours. Stretch first, then get back to it."
        case .professional: "You have worked for 3 hours. A short recovery break is recommended."
        case .mentor: "Three hours of deep work. Come up for air, the craft rewards a steady pace."
        case .coach: "Three hours straight, champ! Time for a real break."
